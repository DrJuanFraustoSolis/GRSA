...
contacts.o hbond.o helix.o grsa.o metropolis.o rgyr.o zimmer.o \
...
opeflx.f opeshe.f minim.f minqsn.f contacts.f hbond.f helix.f grsa.f90  rgyr.f \
...
grsa canon  outpdb  minim  regul contacts interhbond hbond
# metropolis
# ============================================== Linking
